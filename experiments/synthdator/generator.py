...
class Meta:
    ...
    Attributes:
        ...
        column_tags: Словарь {имя_колонки: список_тегов}. Возможные теги:
            - "numeric": числовая колонка
            - "informative": информативная фича (коррелирует с таргетом)
            - "category": категориальная колонка
            - "target": целевая переменная
            - "datetime": временная метка
            - "date": дата
            - "boolean": булева колонка
            - "nullable": колонка содержит NULL значения
